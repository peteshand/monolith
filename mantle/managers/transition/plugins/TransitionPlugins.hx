package mantle.managers.transition.plugins;

import mantle.managers.transition.plugins.TransitionPlugins.DefaultPlugin;
import mantle.managers.transition.plugins.TransitionPlugins.IntPlugin;
...
class TransitionPlugins
{
	...
	static public function getPlugin(prop:String) 
	{
